# Codex execution prompt — TASK-045
...
`TASK-044`. Никогда не реализуй задачу непосредственно в default branch.
...
```text
tasks/TASK_045_paired_tv_phone_virtual_gamepad_e2e.md
...
Не начинай TASK-046 в этом thread.
...
- Planned runner namespace: `automation/gamepad/`; planned basename: `task045_paired_virtual_gamepad.py`.
- Planned test namespace: `tests/`; planned basename: `test_task045_paired_virtual_gamepad.py`.
- Planned report namespace: `docs/qa/reports/`; planned basename: `task045_paired_virtual_gamepad.summary.json`.
