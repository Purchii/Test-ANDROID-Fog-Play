# Codex execution prompt — TASK-050
...
`TASK-044, TASK-046, TASK-047`. Никогда не реализуй задачу непосредственно в default branch.
...
```text
tasks/TASK_050_install_update_persistence_recovery_matrix.md
...
Не начинай TASK-051 в этом thread.
...
- Planned runner namespace: `automation/lifecycle/`; planned basename: `task050_install_persistence_recovery.py`.
- Planned test namespace: `tests/`; planned basename: `test_task050_install_persistence_recovery.py`.
- Planned report namespace: `docs/qa/reports/`; planned basename: `task050_install_persistence_recovery.summary.json`.
