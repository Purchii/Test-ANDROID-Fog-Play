...
| TASK-031 | STOMP signaling and device protocol contract tests | BOUNDED_AUTONOMOUS for offline protocol fixtures only | qa/task-031-stomp-protocol-contracts | in progress; offline STOMP/device protocol fixture harness implemented locally, pending final verification/reviews |
