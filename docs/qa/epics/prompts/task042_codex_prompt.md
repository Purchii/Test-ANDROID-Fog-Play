# Codex execution prompt — TASK-042
...
`TASK-041`. Никогда не реализуй задачу непосредственно в default branch.
...
```text
tasks/TASK_042_local_runtime_preflight.md
...
Не начинай TASK-043 в этом thread.
...
- Planned runner namespace: `automation/runtime_preflight/`; planned basename: `task042_local_runtime_preflight.py`.
- Planned test namespace: `tests/`; planned basename: `test_task042_local_runtime_preflight.py`.
- Planned report namespace: `docs/qa/reports/`; planned basename: `task042_local_runtime_preflight.summary.json`.
