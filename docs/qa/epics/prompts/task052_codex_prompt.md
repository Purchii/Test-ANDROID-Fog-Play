# Codex execution prompt — TASK-052
...
```text
tasks/TASK_052_input_gamepad_lifecycle_coverage.md
...
Не начинай TASK-053 в этом thread.
...
- Planned runner namespace: `automation/input/`; planned basename: `task052_input_gamepad_lifecycle.py`.
- Planned test namespace: `tests/`; planned basename: `test_task052_input_gamepad_lifecycle.py`.
- Planned report namespace: `docs/qa/reports/`; planned basename: `task052_input_gamepad_lifecycle.summary.json`.
