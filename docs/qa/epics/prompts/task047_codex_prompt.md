# Codex execution prompt — TASK-047
...
```text
tasks/TASK_047_sberbox_representative_lane.md
...
Не начинай TASK-048 в этом thread.
...
- Planned runner namespace: `automation/native_regression/`; planned basename: `task047_sberbox_representative_lane.py`.
- Planned test namespace: `tests/`; planned basename: `test_task047_sberbox_representative_lane.py`.
- Planned report namespace: `docs/qa/reports/`; planned basename: `task047_sberbox_representative_lane.summary.json`.
