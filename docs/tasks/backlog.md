...
| TASK-039 | Evidence-backed release-readiness generator | BOUNDED_AUTONOMOUS; PROD_SAFE_OFFLINE_STATIC_ONLY | qa/task-039-evidence-backed-release-readiness-generator | in progress; selected from audit backlog QA-P0-02 after TASK-038 integration; manifest-backed release readiness must remain blocked until authoritative v2 evidence exists |
