# Codex execution prompt — TASK-051
...
`TASK-044, TASK-045, TASK-049`. Никогда не реализуй задачу непосредственно в default branch.
...
```text
tasks/TASK_051_network_api_transport_runtime.md
...
Не начинай TASK-052 в этом thread.
...
- Planned runner namespace: `automation/network/`; planned basename: `task051_network_transport_runtime.py`.
- Planned test namespace: `tests/`; planned basename: `test_task051_network_transport_runtime.py`.
- Planned report namespace: `docs/qa/reports/`; planned basename: `task051_network_transport_runtime.summary.json`.
