# Codex execution prompt — TASK-044
...
```text
tasks/TASK_044_tpv13_reference_lane_oracle_closure.md
...
Не начинай TASK-045 в этом thread.
...
- Planned runner namespace: `automation/native_regression/`; planned basename: `task044_tpv13_reference_lane.py`.
- Planned test namespace: `tests/`; planned basename: `test_task044_tpv13_reference_lane.py`.
- Planned report namespace: `docs/qa/reports/`; planned basename: `task044_tpv13_reference_lane.summary.json`.
