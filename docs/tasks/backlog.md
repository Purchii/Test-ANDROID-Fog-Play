...
| TASK-038 | Evidence schema v2 and authoritative report manifest | BOUNDED_AUTONOMOUS; PROD_SAFE_OFFLINE_STATIC_ONLY | qa/task-038-evidence-schema-v2-report-manifest | verified locally; QA-P0-01/F-004/F-005 foundation only, adds v2 envelope schema and public-safe report manifest without release-generator rewrite; default integration pending |
