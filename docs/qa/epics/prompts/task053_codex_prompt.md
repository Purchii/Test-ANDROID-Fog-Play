# Codex execution prompt — TASK-053
...
`TASK-046, TASK-047, TASK-049, TASK-052`. Никогда не реализуй задачу непосредственно в default branch.
...
```text
tasks/TASK_053_device_equivalence_compatibility_usability.md
...
Не начинай TASK-054 в этом thread.
...
- Planned runner namespace: `automation/compatibility/`; planned basename: `task053_device_equivalence.py`.
- Planned test namespace: `tests/`; planned basename: `test_task053_device_equivalence.py`.
- Planned report namespace: `docs/qa/reports/`; planned basename: `task053_device_equivalence.summary.json`.
