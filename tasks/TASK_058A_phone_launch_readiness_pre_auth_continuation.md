...
`final_reviews_passed_integration_pending`: repository closure is approved,
but no commit SHA, task-branch push, default integration or
`inactive_completed` state may be claimed until those steps succeed.
