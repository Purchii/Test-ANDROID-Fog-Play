# Codex execution prompt — TASK-054
...
`TASK-044, TASK-045, TASK-049, TASK-051, TASK-052, TASK-053`. Никогда не реализуй задачу непосредственно в default branch.
...
```text
tasks/TASK_054_stability_performance_soak.md
...
Не начинай TASK-055 в этом thread.
...
- Planned runner namespace: `automation/performance/`; planned basename: `task054_stability_performance_soak.py`.
- Planned test namespace: `tests/`; planned basename: `test_task054_stability_performance_soak.py`.
- Planned report namespace: `docs/qa/reports/`; planned basename: `task054_stability_performance_soak.summary.json`.
