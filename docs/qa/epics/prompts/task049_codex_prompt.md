# Codex execution prompt — TASK-049
...
`TASK-044, TASK-045, TASK-046, TASK-047`. Никогда не реализуй задачу непосредственно в default branch.
...
```text
tasks/TASK_049_cross_family_transition_state_closure.md
...
Не начинай TASK-050 в этом thread.
...
- Planned runner namespace: `automation/navigation/`; planned basename: `task049_cross_family_graph.py`.
- Planned test namespace: `tests/`; planned basename: `test_task049_cross_family_graph.py`.
- Planned report namespace: `docs/qa/reports/`; planned basename: `task049_cross_family_graph.summary.json`.
