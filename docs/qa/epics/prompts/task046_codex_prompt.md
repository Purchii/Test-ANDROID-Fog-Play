# Codex execution prompt — TASK-046
...
```text
tasks/TASK_046_yandextv_representative_lane.md
...
Не начинай TASK-047 в этом thread.
...
- Planned runner namespace: `automation/native_regression/`; planned basename: `task046_yandextv_representative_lane.py`.
- Planned test namespace: `tests/`; planned basename: `test_task046_yandextv_representative_lane.py`.
- Planned report namespace: `docs/qa/reports/`; planned basename: `task046_yandextv_representative_lane.summary.json`.
