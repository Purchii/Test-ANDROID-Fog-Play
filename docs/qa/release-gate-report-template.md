...
| WebView/payment-safe boundary remains enforced | TASK-008/future runtime | `not_run` | `unknown` | `R1` | Requires confirmed WebView fixtures, staging-only non-real-payment fixtures, redaction, cleanup and real runtime evidence. |
